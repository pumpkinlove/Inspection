...
public class LoginModelImpl implements ILoginModel {
     ...
     * @param inspector
     */
    private void downloadPermission(final Inspector inspector) {
        loginPresenter.showProgressDialog();
        loginPresenter.setProgressDialogCancelable(false);
        ...
        net.downPermission(inspector.getCensorCode())
                .subscribeOn(Schedulers.newThread())
                ...
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Consumer<ResponseEntity<Permission>>() {
                    @Override
                    ...
                    public void accept(Throwable throwable) throws Exception {
                        Log.e("loginModelImpl", "ee" + throwable.getMessage());
                        loginPresenter.showProgressMessage("检查员权限下载失败！");
                        loginPresenter.setProgressDialogCancelable(true);
                    }
                });
    ...
    @Override
    public void downloadInspectPoint(Config config) {
        Retrofit retrofit = new Retrofit.Builder()
                .addConverterFactory(GsonConverterFactory.create())
                .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
                .baseUrl("http://" + config.getIp() + ":" + config.getPort())
        ...
        net.downloadInspectPoint(config.getOrgCode())
                ...
                .subscribe(new Consumer<ResponseEntity<CheckPoint>>() {
                    ...
                    public void accept(Throwable throwable) throws Exception {
                        ...
                        loginPresenter.showProgressMessage("检查点下载失败！");
                        loginPresenter.setProgressDialogCancelable(true);
                    }
                });
    ...
    @Override
    public void downloadPermission(Inspector inspector, Config config) {

    }

    @Override
    public void downloadTask(Config config) {
        loginPresenter.showProgressDialog();
        loginPresenter.setProgressDialogCancelable(false);
        ...
        net.downTask(config.getOrgCode())
                .subscribeOn(Schedulers.newThread())
                ...
                .subscribe(new Consumer<ResponseEntity<CommTask>>() {
                    ...
                    public void accept(Throwable throwable) throws Exception {
                        Log.e("loginModelImpl", "ee" + throwable.getMessage());
                        loginPresenter.showProgressMessage("任务下载失败！");
                        loginPresenter.setProgressDialogCancelable(true);
                    }
                });
